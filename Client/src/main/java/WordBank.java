...
public class WordBank
{
	...
	// if user guessed one word in this category, set to true, so client can disable the button
	...
	/*
		...
		Keyboard is kept differently - upper case means key is available, lower case means it's not.
	...
	public static class WordForClient implements Serializable
	{
		...
		public String toString ()
		{
			...
			//
			// builder.append("WordForClient [id=").append(id);
			// builder.append(", wordForClient=").append(wordForClient);
			// builder.append(", wordCategory=").append(wordCategory);
			// builder.append(", triesLeft=").append(triesLeft);
			// builder.append(", lettersAvailable=").append(lettersAvailable).append("]");
			//
